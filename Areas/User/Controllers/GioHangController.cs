...
";
                ...
                MailMessage message = new MailMessage(new MailAddress("Khamkerd4000@gmail.com", "Success Order"), new MailAddress(email));
        ...
        public IActionResult ThanhToan()
        {
            ...
            foreach (var item in giohang.DsGioHang)
            {
                double thanhTien = item.Quantity * item.ProductPrice;
                totalProductPrice += thanhTien; // Add each product's price to the total product price
            }
